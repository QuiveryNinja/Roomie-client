...
function United_Kingdom() {
    ...
    for(i=0; i<posts.length;i++){
        if(posts[i].Country.toLowerCase() === 'united-kingdom' || posts[i].Country.toLowerCase() === 'united kingdom' || posts[i].Country.toLowerCase() === 'uk'){
        g+=1
        }
    }
                ...
                <div className="filter">
                    ...
                    <div className="Results">      
                        ...
                        {loading ? test3.map((value, key) => {
                            ...
                            r = r.toFixed(1)
                                if(value.Country.toLowerCase() === 'united-kingdom' || value.Country.toLowerCase() === 'unitedkingdom' || value.Country.toLowerCase() === 'uk'){
                                    return (
